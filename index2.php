  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="index2.php?menu=11"><i class="fa fa-dashboard"></i> <span>Voucher</span>
            <span class="pull-right-container"></span> 
          </a>
        </li>
        ...
        <li class="active"><a href="index2.php?menu=13"><i class="fa fa-dashboard"></i> <span>Komentar</span>
            <span class="pull-right-container"></span> 
          </a>
        </li>
      </ul>
...
<div class="content-wrapper">
    <?php
      ...
      if($get=='2'){
        include ("inputDataPengguna.php");
      }elseif($get=='3'){
        include ("inputDataProduk.php");
      }elseif($get=='4'){
        include ("promo.php");
      }elseif($get=='5'){
        include ("form_Input_Pesanan.php");
      }elseif($get=='6'){
        include ("pesanan.php");
      }elseif($get=='7'){
        include ("laporan_penjualan.php");
      }elseif($get=='8'){
        include ("laporan_pengguna.php");
      }elseif($get=='9'){
        include ("laporan_barang_masuk.php");
      }elseif($get=='10'){
        include ("laporan_barang_keluar.php");
      }elseif($get=='11'){
        include ("ket_product.php");
      }elseif($get=='12'){
        include ("faq.php");
      }elseif($get=='13'){
