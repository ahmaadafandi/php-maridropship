        ...
        <div class="col-md-3">
          ...
          <div class="box box-primary">
            <div class="box-body box-profile">
              <img class="profile-user-img img-responsive img-circle" src="gambar/<?php  echo $foto;  ?>" alt="User profile picture" style = "width: 120px; height: 120px;">
              ...
              <ul class="list-group list-group-unbordered">
                ...
                <li class="list-group-item">
                  <b>Nomor Handphone</b> <a class="pull-right"><?php  echo $kontak;  ?></a>
                </li>
              </ul>
        ...
        <div class="col-md-9">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="active"><a href="#activity" data-toggle="tab">All Order</a></li>
