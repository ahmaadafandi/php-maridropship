              ...
              <div class="panel-heading">
                <div class="row">
                  ...
                  <div class="col col-xs-6 text-right">
                    <form action="inputDataPengguna.php" method="post">
              ...
              <div class="panel-body" style="margin: 20px;">
                <table id="dataTables" class="display" cellspacing="0" width="100%">
                  <thead>
                    <tr>
                      ...
                      <th style="width: 30px;">Gambar</th>
                      <th class="hidden-xs">ID DRP</th>
                      <th>Name</th>
                      <th>Level</th>
                      <th>Email</th>
                      <th>Status</th>
                ...
                <tbody>
                  <?php 
                    ...
                    $sql = mysqli_query($conn, "select *from tblpengguna");
                    ...
                    while ($data = mysqli_fetch_array($sql)) {
                      ...
                      $tglKeluar  = $data['tglKeluar'];  ?>
                          ...
                          <td><a class="btn btn-default" style="background: #00c0ef;" href="profil.php?idUser=<?php echo $idUser ?>"><em class="fa fa-user bg-aqua"></em></a></td>
                          <td><img src="gambar/<?php echo $foto; ?>" style="width: 30px; height: 40px;"></td>
                          <td class="hidden-xs"><?php echo $idUser; ?></td>
                          <td><?php echo $nama; ?></td>
                          <td>2</td>
